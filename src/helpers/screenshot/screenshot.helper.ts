...
export class ScreenshotHelper extends BaseHelper {
  ...
  async groupScreenshots(groupName: string = "grouped-screenshots"): Promise<void> {
    ...
    try {
      ...
      this.logger.debug(`Loaded ${screenshotData.length} screenshots as base64 data URIs`);
